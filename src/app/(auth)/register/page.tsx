            ...
            >
                <div className="glass bg-[#141820]/60 p-10 sm:p-14 rounded-[3.5rem] border border-white/5 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.4)] relative overflow-hidden">
                    ...
                    <div className="text-center mb-12 relative z-10">
                        ...
                        <p className="text-text-secondary font-medium tracking-tight">{t("auth.register_subtitle")}</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                        ...
                        <div className="space-y-4">
                            <button
                                ...
                                disabled={loading}
                                className="group w-full flex justify-center items-center py-4.5 px-6 bg-white border border-white/10 rounded-full shadow-[0_20px_40px_-10px_rgba(255,255,255,0.15)] text-xs font-black text-obsidian uppercase tracking-[0.2em] hover:bg-gray-100 transition-all active:scale-95 disabled:opacity-50"
                            >

...
export default function Dashboard() {
    ...
    useEffect(() => {
        // Basic auth check from previous implementation
        const authStatus = sessionStorage.getItem("bali_auth"); // keeping old key for smooth transition for user
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-brand-bg p-4 text-center">
                ...
                >
                    ...
                    <h1 className="text-4xl font-bold font-outfit text-brand-dark dark:text-white mb-3">Think Tracker</h1>
                    <p className="text-gray-500 dark:text-gray-400 mb-8 max-w-[250px] mx-auto text-sm">Organiza as tuas viagens, roteiros e despesas num só lugar.</p>
        ...
        <main className="min-h-screen bg-brand-bg relative pb-24">
                ...
                <div className="max-w-7xl mx-auto flex justify-between items-end">
                    ...
                    <div className="hidden sm:block">
                        <button
                            ...
                            className="px-6 py-3 bg-brand-primary hover:bg-brand-secondary text-white font-semibold rounded-2xl shadow-lg shadow-brand-primary/20 transition-all active:scale-[0.98] flex items-center gap-2"
                        >
            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-12 py-12">
                {loading ? (
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">Sem viagens planeadas</h3>
                        <p className="text-gray-500 dark:text-gray-400 mb-8 max-w-md mx-auto">
                            Ainda não tens nenhuma viagem criada. Começa a planear o teu próximo destino agora.
                        </p>
                        <button
                            onClick={() => setIsCreateModalOpen(true)}
            ...
            {isCreateModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    >
                        <h2 className="text-2xl font-bold font-outfit text-brand-dark dark:text-white mb-6">Nova Viagem</h2>

                        <form onSubmit={handleCreateTrip} className="space-y-5">
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Destino / Título</label>
                                <input
                                    type="text"
                                    required
                                    placeholder="Ex: Verão em Itália"
                                    value={newTripTitle}
                            ...
                            <div>
                                ...
                                <textarea
                                    placeholder="Ex: Roadtrip pela costa amalfitana"
                                    value={newTripDesc}
                            ...
                            <div className="pt-4 flex gap-3">
                                ...
                                >
                                    {isCreating ? <Loader2 size={20} className="animate-spin" /> : 'Criar Viagem'}
                                </button>
                            </div>
                        </form>
                    </motion.div>

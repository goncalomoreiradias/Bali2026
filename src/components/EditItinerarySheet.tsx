                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                {locations.map((loc, idx) => (
                                    <div key={loc.id} className="p-4 bg-gray-50 dark:bg-gray-800 rounded-xl relative group border border-transparent hover:border-gray-200 dark:hover:border-gray-700 transition">
                                        <button
